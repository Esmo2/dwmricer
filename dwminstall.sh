...
#sudo pacman -S skhkd alacritty
sudo apt install sxhkd build-essential libx11-dev libxinerama-dev sharutils suckless-tools libxft-dev libc6

echo "Cloneing Stuff"
cd $HOME/Downloads/
git clone https://github.com/Esmo2/scripts.git
cd
cd $HOME/.config
git clone https://github.com/Esmo2/suckless.git
